...
def model(x, y, _batch_size, _image_size):
    ...
    y_16 = tf.reshape(tf.cast(tf.image.resize_images(y_image, [_image_size // 16, _image_size // 16]), tf.uint8), [-1, _image_size // 16, _image_size // 16])
    ...
    y_08 = tf.reshape(tf.cast(tf.image.resize_images(y_image, [_image_size // 8, _image_size // 8]), tf.uint8), [-1, _image_size // 8, _image_size // 8])
    ...
    y_04 = tf.reshape(tf.cast(tf.image.resize_images(y_image, [_image_size // 4, _image_size // 4]), tf.uint8), [-1, _image_size // 4, _image_size // 4])
    ...
    y_02 = tf.reshape(tf.cast(tf.image.resize_images(y_image, [_image_size // 2, _image_size // 2]), tf.uint8), [-1, _image_size // 2, _image_size // 2])
    ...
    y_01 = tf.reshape(y_image, (-1, _image_size, _image_size))
