...
def model(x, y, _batch_size, _image_size):
    ...
    h_1 = conv2d(h_0, 5, 7, 7, [1, 2, 2, 1], "conv2d_1")
    h_2 = lrelu(batch_norm(conv2d(h_1, 64, 7, 7, [1, 2, 2, 1], "conv2d_2"), name="bn_2"))
    h_3 = conv2d(h_2, 10, 5, 5, [1, 1, 1, 1], "conv2d_3")
    h_4 = conv2d(h_3, 10, 5, 5, [1, 1, 1, 1], "conv2d_4")
    h_5 = lrelu(batch_norm(conv2d(h_4, 10, 5, 5, [1, 1, 1, 1], "conv2d_5"), name="bn_5"))
    h_6 = tf.image.resize_images(h_5, [_image_size, _image_size])
    h_7 = conv2d(h_6, 10, 5, 5, [1, 1, 1, 1], "conv2d_7")
